  ...
  return (
    <div className="relative flex h-full flex-col justify-between overflow-hidden  px-12 py-14 text-foreground">
      ...
      <div className="relative z-10 max-w-2xl space-y-6 px-12">
        ...
        >
          Ready to explore your favorite spots?
        </h1>
        ...
        >
          Sign in to continue discovering hidden gems, tracking your go-to cafes, and finding the perfect workspace for today
        </p>
      </div>
      ...
      >
        "Every morning, I check Spotea to see what&apos;s nearby. It&apos;s become my essential tool for productive days out."
